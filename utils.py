...
def fix_bugs(
    ...
    if 'b74ca5d1' in dataset:
        dataset['b74ca5d1']['train'][2]['output'] = fill(dataset['b74ca5d1']['train'][2]['output'], 4, {(3, 27), (4, 27)})
        dataset['b74ca5d1']['test'][1]['output'] = fill(dataset['b74ca5d1']['test'][1]['output'], 6, {(13, 15)})
